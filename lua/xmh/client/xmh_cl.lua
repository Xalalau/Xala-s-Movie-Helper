...
local function Cleanup(Panel)
    if checkAdmin() == true then
        Panel:Button      (XMH_LANG[_LANG]["client_menu_cleanup_corpses"         ], "xmh_clearcorpses")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_cleanup_corpses_desc"    ])
    end
    Panel:Button          (XMH_LANG[_LANG]["client_menu_cleanup_decals"          ], "xmh_cleardecals")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_cleanup_decals_desc"     ])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_cleanup_decalsmodel"     ], "cl_removedecals")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_cleanup_decalsmodel_desc"])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_cleanup_sounds"          ], "stopsound")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_cleanup_sounds_desc"     ])
    if checkAdmin() == true then
        Panel:Button      (XMH_LANG[_LANG]["client_menu_cleanup_windows"         ], "xmh_repairwindows")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_cleanup_windows_desc"    ])
        Panel:Button      (XMH_LANG[_LANG]["client_menu_cleanup_wpnsitems"       ], "xmh_clearweaponsitems")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_cleanup_wpnsitems_desc"  ])
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_cleanup_auto"            ], "xmh_cleanup_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_cleanup_auto_desc"       ])
    end
end

local function HideOrShow(Panel)
    Panel:Button              (XMH_LANG[_LANG]["client_menu_hideshow_crosshair"        ], "xmh_crosshair")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_crosshair_desc"   ]                 )
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_wvmodels"         ], "xmh_viewmodel_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_wvmodels_desc"    ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_vmodels"          ], "r_drawviewmodel")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_vmodels_desc"     ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_invisible"        ], "xmh_invisible_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_invisible_desc"   ])
    if checkAdmin() == true and not game.SinglePlayer() then
        Panel:CheckBox        (XMH_LANG[_LANG]["client_menu_hideshow_invisibleall"     ], "xmh_invisibleall_var")
        Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_hideshow_invisibleall_desc"])
    end
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_tgun"             ], "xmh_toolgun_var" )
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_tgun_desc"        ])
    if checkAdmin() == true then
        Panel:CheckBox        (XMH_LANG[_LANG]["client_menu_hideshow_tgunsound"        ], "xmh_toolgunmute_var" )
        Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_hideshow_tgunsound_desc"   ])
    end
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_pgun"             ], "xmh_physgun_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_pgun_desc"        ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_errors"           ], "xmh_error_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_errors_desc"      ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_misc"             ], "xmh_weapammitem_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_misc_desc"        ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_voicen"           ], "xmh_chatvoice_var")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_voicen_desc"      ])
    if checkAdmin() == true then
        if not game.SinglePlayer() then
            Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_hideshow_voicei"           ], "xmh_voiceicons_var")
            Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_hideshow_voicei_desc"      ])
        end
        Panel:CheckBox        (XMH_LANG[_LANG]["client_menu_hideshow_foot"             ], "xmh_footsteps_var")
        Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_hideshow_foot_desc"        ])
    end
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_decmod"           ], "r_drawmodeldecals")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_decmod_desc"      ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_particles"        ], "r_drawparticles")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_particles_desc"   ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_3dskybox"         ], "r_3dsky")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_3dskybox_desc"    ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_water"            ], "cl_show_splashes")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_water_desc"       ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_ropes"            ], "r_drawropes")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_ropes_desc"       ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_laser"            ], "r_DrawBeams")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_laser_desc"       ])
    Panel:CheckBox            (XMH_LANG[_LANG]["client_menu_hideshow_ents"             ], "r_drawentities")
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_ents_desc"        ])
    if checkAdmin() == true then
        Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_hideshow_corpses"          ], "xmh_corpses_var", 0, 200, 0)
        Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_hideshow_corpses_desc"     ])
    end
    Panel:NumSlider           (XMH_LANG[_LANG]["client_menu_hideshow_deathn"           ], "hud_deathnotice_time", 0, 12, 0)
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_deathn_desc"      ])
    Panel:NumSlider           (XMH_LANG[_LANG]["client_menu_hideshow_bchat"            ], "hud_saytext_time", 0, 24, 0)
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_bchat_desc"       ])
    Panel:NumSlider           (XMH_LANG[_LANG]["client_menu_hideshow_decals"           ], "xmh_decals_var", 1, 5096, 0)
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_decals_desc"      ])
    Panel:NumSlider           (XMH_LANG[_LANG]["client_menu_hideshow_detail"           ], "cl_detaildist", 0, 20000, 0)
    Panel:ControlHelp         (XMH_LANG[_LANG]["client_menu_hideshow_detail_desc"      ])
end

local function Flashlight(Panel)
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_flashlight_lock"           ], "r_flashlightlockposition")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_lock_desc"      ])
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_flashlight_brightness"     ], "xmh_fullflashlight_var")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_brightness_desc"])
    --Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_flashlight_area"           ], "r_flashlightdrawfrustum") -- Stopped working (14/11/16)
    --Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_area_desc"      ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_flashlight_minr"           ], "r_flashlightnear", 1, 1000, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_minr_desc"      ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_flashlight_maxr"           ], "r_flashlightfar", 1, 10000, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_maxr_desc"      ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_flashlight_fov"            ], "r_flashlightfov", 1, 179, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_flashlight_fov_desc"       ])
end

local function General(Panel)
    Panel:Button          (XMH_LANG[_LANG]["client_menu_general_editor"       ], "xmh_texteditor")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_editor_desc"  ])
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_fontsize"     ], "xmh_textfont_var", 13, 30, 0)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_fontsize_desc"])
    if not game.SinglePlayer() then
        Panel:Button      (XMH_LANG[_LANG]["client_menu_general_lipsync"      ], "xmh_lipsync")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_general_lipsync_desc" ])
    end
    Panel:CheckBox        (XMH_LANG[_LANG]["client_menu_general_shake"        ], "xmh_shake_var")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_shake_desc"   ])
    if (GetConVar("sv_skyname"):GetString() != "painted") then
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_general_green"        ], "xmh_skybox_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_general_green_desc"   ])
    end
    if checkAdmin() == true then
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_general_autosave"     ], "xmh_save_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_general_autosave_desc"])
    end
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_lod"          ], "r_lod", -1, 5, 0)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_lod_desc"     ])
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_pupil"        ], "r_eyesize", -0.5, 0.5, 2)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_pupil_desc"   ])
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_fov"          ], "xmh_fov_var", 0, 90, 0)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_fov_desc"     ])
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_vfov"         ], "viewmodel_fov", 0, 360, 0)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_vfov_desc"    ])
    Panel:NumSlider       (XMH_LANG[_LANG]["client_menu_general_cfov"         ], "xmh_camera_fov", 0, 90, 0)
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_general_cfov_desc"    ])
end

local function NPCMovement(Panel)
    Panel:Button          (XMH_LANG[_LANG]["client_menu_npcmov_select"             ], "npc_select")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_npcmov_select_desc"        ])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_npcmov_move"               ], "npc_go")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_npcmov_move_desc"          ])
    if checkAdmin() == true then
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_npcmov_run"                ], "xmh_npcwalkrun_var") -- Bug: npc_go_do_run allways returns 1...
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_npcmov_run_desc"           ])
    end
    Panel:Button          (XMH_LANG[_LANG]["client_menu_npcmov_random"             ], "npc_go_random")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_npcmov_random_desc"        ])
    if checkAdmin() == true and game.SinglePlayer() then
        Panel:Button      (XMH_LANG[_LANG]["client_menu_npcmov_turnpedestrian"     ], "xmh_pedestrians" )
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_npcmov_turnpedestrian_desc"])
    end
    Panel:Help            ("________________________________"                      )
    if checkAdmin() == true then
        Panel:Help        (XMH_LANG[_LANG]["client_menu_npcmov_mov_msg"            ])
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_npcmov_ai_disabled"        ], "xmh_aidisabled_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_npcmov_ai_disabled_desc"   ])
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_npcmov_ai_disable"         ], "xmh_aidisable_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_npcmov_ai_disable_desc"    ])
    else
...
local function Physics(Panel)
    if checkAdmin() == true then
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_physics_motion"       ], "xmh_mode_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_motion_desc"  ])
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_physics_fall"         ], "xmh_falldamage_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_fall_desc"    ])
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_time"         ], "xmh_timescale_var", 0.06, 2.99, 2)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_time_desc"    ])
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_push"         ], "xmh_knockback_var", -9999, 9999, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_push_desc"    ])
    end
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_pgunf"        ], "physgun_wheelspeed", 0, 100, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_pgunf_desc"   ])
    if checkAdmin() == true then
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_throw"        ], "xmh_throwforce_var", 0, 20000, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_throw_desc"   ])
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_noclip"       ], "xmh_noclipspeed_var", 1, 300, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_noclip_desc"  ])
    end
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_walk"         ], "xmh_walkspeed_var", 1, 10000, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_walk_desc"    ])
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_run"          ], "xmh_runspeed_var", 1, 10000, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_run_desc"     ])
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_jump"         ], "xmh_jumpheight_var", 0, 4000, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_jump_desc"    ])
    if checkAdmin() == true then
        Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_physics_friction"     ], "xmh_wfriction_var", -20, 50, 0)
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_physics_friction_desc"])
    end
end
...
local function Shadows(Panel)
    ...
    Panel:Button      (XMH_LANG[_LANG]["client_menu_shadows_res_desc"       ], "xmh_shadowreschk")
    ...
    Panel:Button      (XMH_LANG[_LANG]["client_menu_shadows_change"         ], "xmh_shadowres")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_shadows_notes"          ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_shadows_bleeding"       ], "mat_slopescaledepthbias_shadowmap", 1, 16, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_shadows_bleeding_desc"  ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_shadows_blur"           ], "r_projectedtexture_filter", 0, 20, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_shadows_blur_desc"      ])
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_shadows_brightness"     ], "mat_fullbright")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_shadows_brightness_desc"])
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_shadows_match"          ], "r_shadowrendertotexture")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_shadows_match_desc"     ])
end

local function Teleport(Panel)
    Panel:TextEntry   (XMH_LANG[_LANG]["client_menu_teleport_name"       ], "xmh_positionname_var")
    Panel:Button      (XMH_LANG[_LANG]["client_menu_teleport_save"       ], "xmh_saveteleport")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_teleport_save_desc"  ])
    Panel:Help        (""                                                )
    teleport_combobox = Panel:ComboBox(XMH_LANG[_LANG]["client_menu_teleport_destination"])
    LoadTeleports()
    Panel:Button      (XMH_LANG[_LANG]["client_menu_teleport_delete"     ], "xmh_deleteteleportpos")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_teleport_delete_desc"])
    Panel:Button      (XMH_LANG[_LANG]["client_menu_teleport_go"         ], "xmh_teleporttopos")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_teleport_go_desc"    ])
end

local function ThirdPerson(Panel)
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_thirdp_enable"            ], "xmh_person_var")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_enable_desc"       ])
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_thirdp_info"              ], "cam_showangles")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_info_desc"         ])
    Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_thirdp_colision"          ], "cam_collision")
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_colision_desc"     ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_distance"          ], "cam_idealdist", 30, 200, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_distance_desc"     ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_cam_downup"        ], "cam_idealdistup", -120, 120, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_cam_downup_desc"   ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_cam_leftright"     ], "cam_idealdistright", -200, 200, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_cam_leftright_desc"])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_ang_downup"        ], "cam_idealpitch", 0, 90, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_ang_downup_desc"   ])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_and_leftright"     ], "cam_idealyaw", -135, 135, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_and_leftright_desc"])
    Panel:NumSlider   (XMH_LANG[_LANG]["client_menu_thirdp_spinvel"           ], "cam_ideallag", 0, 6000, 0)
    Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_thirdp_spinvel_desc"      ])
end

local function Weapons(Panel)
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_drop"          ], "xmh_dropweapon")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_drop_desc"     ])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_remove"        ], "xmh_removeweapon")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_remove_desc"   ])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_dropammop"     ], "xmh_removeprimaryammo")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_dropammop_desc"])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_dropammos"     ], "xmh_removesecondaryammo")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_dropammop_desc"])
    Panel:CheckBox        (XMH_LANG[_LANG]["client_menu_weapons_all"           ], "xmh_editallweapons_var")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_all_desc"      ])
    Panel:Help            (""                                                  )
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_givegm"        ], "xmh_givegmweapons")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_givegm_desc"   ])
    Panel:Button          (XMH_LANG[_LANG]["client_menu_weapons_givehl2"       ], "xmh_givehl2weapons")
    Panel:ControlHelp     (XMH_LANG[_LANG]["client_menu_weapons_givehl2_desc"  ])
    Panel:Help            (""                                                  )
    if checkAdmin() == true and not game.SinglePlayer() then
        Panel:CheckBox    (XMH_LANG[_LANG]["client_menu_weapons_plyall"        ], "xmh_editweaponsallplys_var")
        Panel:ControlHelp (XMH_LANG[_LANG]["client_menu_weapons_plyall_desc"   ])
    end
end
...
local function Defaults(Panel)
    ...
    if checkAdmin() == false then
        Panel:Button         (XMH_LANG[_LANG]["client_menu_defaults_set_ply"           ], "xmh_defaults")
        Panel:ControlHelp    (XMH_LANG[_LANG]["client_menu_defaults_set_ply_desc"      ])
    elseif checkAdmin() == true then
        Panel:Button         (XMH_LANG[_LANG]["client_menu_defaults_set_admin"         ], "xmh_defaults")
        Panel:ControlHelp    (XMH_LANG[_LANG]["client_menu_defaults_set_admin_desc"    ])
        if not game.SinglePlayer() then
            Panel:CheckBox   (XMH_LANG[_LANG]["client_menu_defaults_set_admin_all"     ], "xmh_defaultsall_var")
            Panel:ControlHelp(XMH_LANG[_LANG]["client_menu_defaults_set_admin_all_desc"])
        end
    end
end
...
hook.Add("PopulateToolMenu", "All hail the menus", function ()
    ...
    spawnmenu.AddToolMenuOption("Utilities", "Xala's Movie Helper", XMH_LANG[_LANG]["client_populate_menu_section10"], XMH_LANG[_LANG]["client_populate_menu_section10"], "", "", ThirdPerson )
